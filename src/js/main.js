window.onload = function () {
    ...
    document.addEventListener('keydown', e => {
        document.querySelectorAll('.dropdown-item__link').forEach(item => (item === document.activeElement) && menuList.classList.add('menu__list--active'));

        (document.activeElement === document.querySelector('.social__item')) && menuList.classList.remove('menu__list--active');
    });
